...
function validate()
{  
var title = document.deletepage.txttitle.value;  
  
if (title == null || title == "")
{  
  alert("MUSIC TITLE CANNOT BE BLANK");  
  return false;  
}
}  
</script>
			...
			<div id="header">
				...
				<ul>
					<div id="nav1" style="margin-top=50%">
						<form name="deletepage" action="AdminController" method="post" onsubmit="return validate()">
							<table align="center" style="margin-top=50%">
								<tr >
									<td>Enter Music Title :</td>
									<td ><input type="text" name="txttitle"></input></td>
								</tr>
